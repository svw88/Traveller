...
var ngGapiModule = angular.module('ngGapi', []).service("$gapi", function() {
	...
	(function() {/*
		...
		var G = function(a, b, c) {
		    ...
		    K = function(a, b, c) {
			b && 0 < b.length && ( b = J(b), c && 0 < c.length && (b += "___" + J(c)), 28 < b.length && ( b = b.substr(0, 28) + (b.length - 28)),
			c =
			b,
			b = u(da, "_p", w()), u(b,c,w())[a] = (new Date).getTime(), G(a, "_p", c))
		},
		    J = function(a) {
		...
		var R = decodeURI("%73cript"),
			...
			if (!b || !b.length)
				return A.nonce = null;
			for (var c = h.getElementsByTagName(R),
			    d = 0,
			    e = c.length; d < e; ++d) {
				var f = c[d];
				if (f.src && ( a = String(f.nonce || f.getAttribute("nonce") || "") || null)) {
					for (var l = 0,
					    k = b.length; l < k && b[l] !== f.src; ++l);
		    ...
		    Z = function(a, b) {
			var c = b || {};
			"function" == typeof b && ( c = {}, c.callback =
			b);
			qa(a, c);
			b = a ? a.split(":") : [];
			var d = c.h || oa(),
	...
	gapi.load("client", {
		...
		_c : {
			"jsl" : {
				...
				"h" : "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.vY-OG-G70wM.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCNwD_Uh4sL4S9NVYwk8G2jQw_vRQQ",
				"u" : "https://apis.google.com/js/client.js",
				"hee" : true,
				"fp" : "a113f948d63e3190b88e6325b5434281e124b497",
				"dpo" : false
			},
			"fp" : "a113f948d63e3190b88e6325b5434281e124b497",
